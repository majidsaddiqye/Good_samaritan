      ...
      <section className="bg-red-800 text-cream-100 py-16 bg-gradient-to-b from-cream-50/10 to-transparent">
        <div className="container max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto font-sans">
            Discover the journey of the Good Samaritans Ministry in serving
            Kampala’s most vulnerable.
          </p>
        </div>
      </section>
              ...
              >
                <div className="w-full md:w-1/2">
                  <img
                    src={milestone.image}
                    alt={milestone.title}
                    className="w-full h-64 object-cover rounded-lg shadow-md border border-cream-200"
                  />
                </div>
                <div className="w-full md:w-1/2">
                  ...
                  <p className="text-gray-700 font-sans">{milestone.description}</p>
                </div>
              </div>
            ))}
          </div>
